...
//		TC-9 Locators
	...
	/**
	 * @Test Case 2: Check the Heading of SubStore Module
	 *
	 * @method checkHeadingAndTiles()
	 *
	 * @param None
	 *
	 * @description 
	 * To ensure that the "Select Your Substore" heading is displayed and all expected sub-module cards/tiles are also displayed.
	 *
	 * @steps
	 * 1. Locate and click on the 'Substore' module link or button in the main navigation menu
	 * 2. Upon clicking the 'Substore' module, the "Select Your Substore" heading should appear on it.
	 * 3. All specified sub-module cards/tiles (more than 4) should be present and displayed correctly
	...
	public boolean checkHeadingAndTiles() throws Exception {
		try {
